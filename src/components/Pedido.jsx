...
const Pedido = () => {
    ...
    // HOOK-useStafe-Manipula o estado da variavel
    ...
    // usa a função updater para garantir o valor mais recente do estado
        ...
        // MAP: percorre a lista para criar um NOVO array sem modificar o original(IMUTABILIDADE)
            prev.map(item=>
                // TERNÁRIO: verifica se o item da interação atual e o que deve ser alterado
    ...
    const confirmarPedido=()=>{
        ...
        setTimeout(()=>{
            setStatus("Seu pedido sai para a entrega!")
            setEnviar(false)
        },5000);
        setTimeout(()=>{
